...
const (
	...
	// FloatChunkEncodingXOR2 selects XOR2 encoding for float chunks; requires --enable-feature=xor2-encoding or --enable-feature=st-storage.
...
type ChunkEncodingConfig struct {
	...
	// follows the startup feature selection. Setting "xor2" requires xor2-encoding or
	// st-storage to be enabled.
